...
CREATE PROCEDURE addCinemaRoom(IN  roomNumber INT,IN  numberPlace INT)
    BEGIN

INSERT INTO cinemarooms (roomNumber, numberPlace)  VALUES( roomNumber, numberPlace);
...
CREATE PROCEDURE addComplexe(IN name VARCHAR(255),IN address VARCHAR(255), city VARCHAR(255) , slug VARCHAR(255) )
BEGIN
INSERT INTO complexes (name, address, city, slug)  VALUES( name, address, city, slug);
...
CREATE PROCEDURE addCustomer(in customerFirstname VARCHAR(255), in customerLastname VARCHAR(255), in customerAddress VARCHAR(255), in customerCity VARCHAR(255), in customerEmail VARCHAR(255), customerPass VARCHAR(255))

BEGIN
INSERT INTO customers (customerFirstname, customerLastname, customerAddress, customerCity, customerEmail, customerPass) VALUES( customerFirstname, customerLastname, customerAddress, customerCity, customerEmail, customerPass);
...
DELIMITER $$
CREATE PROCEDURE addListOfRoomComplexe(in complexeId INT(2),in cinemaRoomId INT(2)) BEGIN INSERT
INTO
    listofroomcomplexe
    (complexeId, cinemaRoomId)
VALUES
    ( complexeId, cinemaRoomId);
END $$ DELIMITER ;
...
DELIMITER $$
CREATE PROCEDURE addMovie(in movieName VARCHAR(255), in moviePicture VARCHAR(255), in movieDesc VARCHAR(255), in slug VARCHAR(255))
BEGIN
INSERT INTO movies(movieName, moviePicture, movieDesc, slug) VALUES( movieName, moviePicture, movieDesc, slug);
END $$
DELIMITER ;
...
DELIMITER $$
CREATE PROCEDURE addSessionMovies(IN listOfRoom INT, IN movieId INT, IN sessionDate VARCHAR(255) )
BEGIN
INSERT INTO sessions(listOfRoom, movieId, date) VALUES( listOfRoom, movieId, sessionDate);
END $$
DELIMITER ;
...
DELIMITER $$
CREATE PROCEDURE addReservations(IN reservationId INT(11), IN customerId INT(11), IN numberPlace INT(2), IN total VARCHAR(255), IN sessionId INT(11))
BEGIN
INSERT INTO reservations (reservationId, customerId, numberPlace, total, sessionId) VALUES( reservationId, customerId, numberPlace, total, sessionId);
END $$
DELIMITER ;
